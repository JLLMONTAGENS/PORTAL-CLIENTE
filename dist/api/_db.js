...
function publicConversation(row){return row?{id:row.id,ticketNumber:row.ticket_number,customerName:row.customer_name,phone:row.phone,status:row.status,createdAt:row.created_at,updatedAt:row.updated_at}:null}
